...
class AnthropicProvider(LLMProvider):
    ...
    def __init__(self, model: str = "claude-3-5-haiku-20241022", temperature: float = 0.7):
        """
...
class LLMManager:
    ...
    def __init__(self, provider: str = "openai", model: Optional[str] = None):
        ...
        if self.provider_name == "openai":
            ...
            self.provider = AnthropicProvider(model or "claude-3-5-haiku-20241022")
        else:
...
if __name__ == "__main__":
    ...
    # Test streaming
    try:
        print("Testing Streaming (OpenAI):")
